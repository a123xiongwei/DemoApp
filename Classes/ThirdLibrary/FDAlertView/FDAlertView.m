...
- (void)setContentView:(UIView *)contentView andHeight:(CGFloat)height
{
    _contentView = contentView;
    _contentView.center = self.center;

    CGFloat originX = _contentView.frame.origin.x;
    CGFloat originY = _contentView.frame.origin.y - height;
    CGFloat sizeW   = _contentView.frame.size.width;
    CGFloat sizeY   = _contentView.frame.size.height;

    _contentView.frame = CGRectMake(originX, originY, sizeW, sizeY);
...
-(void)showDialog:(UIView *) superView{
    [superView addSubview:self];
    
//    CGFloat width = superView.bounds.size.width * 0.5;
//    CGFloat height = superView.bounds.size.height * 0.5;
//    
//    self.center = CGPointMake(width, height - 100);
 ...
 *  @param yValue Y值
 */
-(void)setConentPosition:(CGFloat) yValue{
    _contentView.center = self.center;
    
    CGFloat originX = _contentView.frame.origin.x;
    CGFloat originY = _contentView.frame.origin.y - yValue;
    CGFloat sizeW   = _contentView.frame.size.width;
    CGFloat sizeY   = _contentView.frame.size.height;
