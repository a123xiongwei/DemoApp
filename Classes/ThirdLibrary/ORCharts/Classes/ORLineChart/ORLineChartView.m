...
- (void)_or_initUI {
    ...
    titleLa.frame = CGRectMake(0, 0, 100, 30);
    titleLa.text = @"体重(KG)";
    titleLa.textColor = [CommUtils colorWithHexString:@"#00ADEF"];
    titleLa.font = [UIFont systemFontOfSize:15 weight:UIFontWeightMedium];
