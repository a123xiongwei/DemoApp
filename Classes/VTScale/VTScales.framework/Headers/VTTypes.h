...
typedef enum
{
	...
	VT_DEVICE_MODEL_VTAG = 0x01,
    VT_DEVICE_MODEL_VTOY = 0x02,
    VT_DEVICE_MODEL_VSCALE = 0x03,
    VT_DEVICE_MODEL_VSCALE2 = 0x08,
    VT_DEVICE_MODEL_SMARTBEAN = 0x04,
    VT_DEVICE_MODEL_IBEACON = 0x05,
    VT_DEVICE_MODEL_MEDICAL = 0x07,
    VT_DEVICE_MODEL_UNKNOWN = 0xfe,
    VT_DEVICE_MODEL_ALL= 0xff,
