...
- (instancetype)initWithVersion:(UInt8)version type:(UInt8)type subType:(UInt8)subType vendor:(UInt8)vendor;

- (BOOL)isEqualDeviceModelNumber:(VTDeviceModelNumber *)deviceModelNumber;
