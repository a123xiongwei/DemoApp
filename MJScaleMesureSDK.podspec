Pod::Spec.new do |s|
  ...
  spec.homepage     = "https://github.com/a123xiongwei/DemoApp"
  spec.license      = { :type => "MIT", :file => "FILE_LICENSE" }
  
  s.author        = { 'CoderTitan' => 'androidxiong@163.com' } #作者
  s.platform      = :ios, '8.0' #支持的平台
  s.requires_arc  = true #arc和mrc选项
 
  s.ios.vendored_frameworks = 'VTScale/VTScales.framework' # 依赖的第三方/自己的framework
    ...
    #文件配置项
    s.source        = { :git => 'https://github.com/a123xiongwei/DemoApp.git', :tag => s.version.to_s }
